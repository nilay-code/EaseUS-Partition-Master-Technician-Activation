...
4- Run the "EPM v14 Activator v1.1.exe" app and click the [Activate] button, then when it asks where
EaseUS Partition Master is installed, show the path to the exact installation directory of
